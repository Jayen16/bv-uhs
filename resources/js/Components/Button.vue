...
const variantClasses = (variant) => ({
    'bg-green-500 text-white hover:bg-green-600 focus:ring-purple-500': variant == 'primary',
    ...
    'bg-[#186434] text-white hover:bg-[#3caa64] focus:ring-[#3caa64]': variant == 'success',
